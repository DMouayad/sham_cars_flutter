...
class MyQuestionsCubit extends Cubit<PagedState<Question>> {
  MyQuestionsCubit(this._repo) : super(const PagedState<Question>());
  ...
  Future<void> loadInitial() async {
    ...
    try {
      ...
      final items = await _repo.getMyQuestions(
        accessToken: token,
        limit: _limit,
        skip: 0,
      );
